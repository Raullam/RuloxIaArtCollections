        ...
        <div className="flex flex-col justify-center items-center">
          ...
          >
            ...
            <div className="flex flex-col font-semibold">
              ...
              <span className="text-[#e32970] text-xs">Rulox</span>
            </div>
          </a>

          <p className="text-white text-sm font-medium text-center">
            Raül Lama kick-started his journey as a software engineer in
            2018. <br /> Over the years, he has grown full-blown skills in
